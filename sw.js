// FollowLoop PWA Service Worker (V5.5.4 - Dual-Mode Speed & HITL Memory Set SSOT)
// 快取策略：靜態資源 Network-First (網路優先+快取備援)，API / GAS 請求 Network-Only (完全直通)
// 支援 Web Share Target Level 2 檔案接收並安全中轉至 IndexedDB

const CACHE_NAME = 'followloop-pwa-v5.5.4';
...
const STATIC_ASSETS = [
  ...
  './js/hitl_reviewer.js?v=5.5.4',
  './js/live_view.js?v=5.2.4',
  './js/project_manager.js?v=5.2.4',
  './js/auth.js?v=5.2.4',
  './js/app.js?v=5.2.5',
  './js/background-pipeline.js?v=5.5.4',
  ...
  './js/modules/hitl_log_modal.js?v=5.5.0',
  './js/modules/ingestion_gate.js?v=5.5.0',
  './js/modules/share_target.js?v=5.5.0',
